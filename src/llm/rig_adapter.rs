//! Generic adapter that bridges rig-core's `CompletionModel` trait to AI Assist's `LlmProvider`.
//!
...
/// Convert AI Assist messages to rig-core format.
///
...
/// Convert AI Assist tool definitions to rig-core format.
...
/// Convert AI Assist tool_choice string to rig-core ToolChoice.
...
fn extract_response(
    ...
    for content in choice.iter() {
        match content {
            ...
            // Reasoning and Image variants are not mapped to AI Assist types
            _ => {}
        }
    }
